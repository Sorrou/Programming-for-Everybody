...
9098 us do many different things.

Our computers are fast and have vast amounts of memory and 
could 1823 be 9717 very 6204 helpful to us if we only knew the language to
 speak to explain to the computer what we would like it to 
do next.  If we knew this language, we could tell the 
computer to do tasks on our behalf that were repetitive.  
240 Interestingly, the kinds of things computers can do best
...
Our 4411 personal 3260 information 4794 analysis assistant quickly 
 told us that the word to was used sixteen times in the
7360 first three paragraphs of this chapter.

This very fact that computers are good at things 
that 5395 humans 4494 are 6622 not is why you need to become
...
4312 If we think of programs as the creative output of groups of programmers, 3958
...
instead 5179 for 7133 us 1705 to be more productive in handling the data and 
...
1254 Computer hardware architecture
...
4376 store information even when there is no power to the 9262
computer.  Examples of secondary memory are disk drives
or flash memory (typically found in USB sticks and portable
music players).
2388 9705 305
9751 Input and Output Devices are simply our 1711
...
559 retrieve data that might not always be up.  So in a sense, 1365
...
secondary 7964 memory, 572 network, 8608 or the input/output devices.
...
8257 We call these stored instructions a program and the act 
of writing these instructions down and getting the instructions to 
be correct programming.

Understanding programming

3633 In the rest of this book, we will try to turn you into a person 9565
...
7122 First, you need to know the programming language (Python) - 9361
...
6323 quizzical look on their face until you say a reserved word.  
For example, if you say, 
5577 I wish more people would walk to improve their overall health, 3621
...
break 2055  8322  6579   except    import    print              
 class     exec      in        raise              
continue  finally   is        return             
def       for       lambda    try

That is it, and unlike a dog, Python is already completely trained.
1860 When you say try, Python will try every time you say it without 3396
fail.
...
And 1228 we 353 have 8028 even written our first syntactically correct Python sentence.
...
1261 The >>> prompt is the Python interpreter's way of asking you, What
...
850 to say good-bye when interacting with the inhabitants 2297
of Planet Python:
...
6479 PHP, Ruby, Basic, Perl, JavaScript, and many more.  The actual hardware
...
123 and these translators convert the programs to machine language for actual 9334
...
a 314 machine 9196 language 8727 version of the program for the new machine.
...
If 304 you 4803 have 9206 a Windows system, often these executable machine language programs have a
...
5706 If you were to open an executable file in a text editor, it would look 
...
6352 it written in?  Is it written in a compiled language?  When we type 2881
...
which 4234 is 3139 called 5794 a script.  By
